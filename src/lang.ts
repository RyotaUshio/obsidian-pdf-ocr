...
export function isTesseractLanguage(lang: string): lang is TesseractLanguage {
    return lang in TESSERACT_LANGUAGES;
}

export function getLanguageName(lang: TesseractLanguage): string {
    return TESSERACT_LANGUAGES[lang];
}
